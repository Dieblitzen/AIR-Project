...
res = bbox_for_image("test",(4,5,6),[[1,1,3,3],[2,2,5,5]])
res2 = bbox_for_image("test2",(4,5,6),[[1,1,3,3],[2,2,5,5]])
tree = etree.ElementTree(res)
tree.write("images/test.xml")

tree2 = etree.ElementTree(res2)
tree2.write("images/test2.xml")
